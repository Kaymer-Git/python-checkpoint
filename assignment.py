...
#
# Store the answer in:
work_hours = int(input("How amny hours do you work a day? "))
# work_hours
...
#
# Store the answer in:
hourly_rate = float(input("How mach do you earn per hour? "))
# hourly_rate
#
# THINK:
...
# TASK 44:
# Create:
money_after_spending = five_day_pay - float(input("Hoe much money did you spent? "))
# money_after_spending
#
# Ask the user how much money they spent.
#
# Subtract that amount from five_day_pay.
print(money_after_spending)
